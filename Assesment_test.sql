...
/*SQL Assessment Test 2 Questions*/
...
/* 6) How can you retrieve the details of facilities with ID 1 and 5? Try to do it without 
...
/* 12) Produce a list of facilities with more than 1000 slots booked. Produce an output table consisting 
